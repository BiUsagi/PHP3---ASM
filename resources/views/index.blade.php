            ...
            <div class="swiper sliderFeaturedPosts">
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                  <a href="{{ url('tintuc/'. $tin->id) }}" class="img-bg d-flex align-items-end" style="background-image: url('{{ url('img/'. $tin->hinhanh ) }}');">
        ...
        <div class="row g-5">
          <div class="col-lg-4">
            ...
            <div class="post-entry-1 lg">
              <a href="{{ url('tintuc/'. $tin->id) }}"><img src="{{ url('img/'. $tin->hinhanh ) }}" alt="" class="img-fluid"></a>
              <div class="post-meta">
                <span class="date">
                   {{-- lấy loại --}}
                   @php
                   $loai = DB::table('theloai_asm')
                   ->select('ten')
                   ->where('id', $tin->theloai_id)
                   ->first();
                   echo $loai->ten;
               @endphp
                </span> 
            ...
            <div class="post-entry-1 border-bottom">
              ...
              <h2 class="mb-2"><a href="{{ url('tintuc/'. $tin->id) }}">The Best Homemade Masks for Face (keep the Pimples Away)</a></h2>
              <span class="author mb-3 d-block">Jenny Wilson</span>
            </div>

            <div class="post-entry-1">
              <div class="post-meta"><span class="date">Lifestyle</span> <span class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
              <h2 class="mb-2"><a href="{{ url('tintuc/'. $tin->id) }}">10 Life-Changing Hacks Every Working Mom Should Know</a></h2>
              <span class="author mb-3 d-block">Jenny Wilson</span>
            </div>
        ...
        <div class="row">
          <div class="col-md-9">
            ...
            <div class="d-lg-flex post-entry-2">
              ...
              <a href="{{ url('tintuc/'. $esp->id) }}" class="me-4 thumbnail mb-4 mb-lg-0 d-inline-block">
                <img src="{{ url('img/'. $esp->hinhanh ) }}" alt="" class="img-fluid">
              </a>  
              <div>
                <div class="post-meta"><span class="date">ESPORST</span> <span class="mx-1">&bullet;</span> <span>{{ $esp->created_at }}</span></div>
            ...
            <div class="row">
              <div class="col-lg-4">
                ...
                <div class="post-entry-1 border-bottom">
                  <a href="{{ url('tintuc/'. $esp->id) }}"><img src="{{ url('img/'. $esp->hinhanh ) }}" alt="" class="img-fluid"></a>
                  <div class="post-meta"><span class="date">ESPORST</span> <span class="mx-1">&bullet;</span> <span>{{ $esp->created_at }}</span></div>
                  <h2 class="mb-2"><a href="{{ url('tintuc/'. $esp->id) }}">{{ $esp->ten }}</a></h2>
                  <span class="author mb-3 d-block">Jenny Wilson</span>
        ...
        <div class="row">
          <div class="col-md-9 order-md-2">
            ...
            <div class="row">
              <div class="col-lg-4">
                <div class="post-entry-1 border-bottom">
                  <a href=""><img src="img/post-landscape-5.jpg" alt="" class="img-fluid"></a>
                  <div class="post-meta"><span class="date">Business</span> <span class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
              ...
              <div class="col-lg-8">
                <div class="post-entry-1">
                  <a href=""><img src="img/post-landscape-7.jpg" alt="" class="img-fluid"></a>
                  <div class="post-meta"><span class="date">Business</span> <span class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
          ...
          <div class="col-md-3">
            ...
            <div class="post-entry-1 border-bottom">
              <div class="post-meta"><span class="date">Công Nghệ</span> <span class="mx-1">&bullet;</span> <span>{{ $cn->created_at }}</span></div>
